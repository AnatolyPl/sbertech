...
class AppConfiguration:
    ...
    debug: bool = False
    contact: ContactInfo = field(default_factory=lambda: ContactInfo(name="Anatoly Ploshchadnyy",
...
def get_config() -> AppConfiguration:
    return deployment_config() if getenv("ENV_NAME", "local") == "deploy" else dev_config()
