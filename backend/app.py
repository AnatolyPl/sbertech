...
from backend.pydantic_models.common import ValidationErrorResponse, UnexpectedErrorResponse
...
def create_app() -> FastAPI:
    ...
    async def validation_exception_handler(request: Request, exc: RequestValidationError) -> JSONResponse:
        ...
        return JSONResponse(content=jsonable_encoder({"error": " AND ".join(f"{error['msg']}" for error in exc.errors())}),
